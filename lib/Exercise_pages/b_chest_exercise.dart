...
class ChestExercise extends StatefulWidget {
  ...
  @override
  State<ChestExercise> createState() => _ChestExerciseState();
}
                        ...
                        body: Column(
                          children: [
                            Padding(
                              ...
                              child: Image.asset('assets/images/inclined_pushups.gif'),
                            ),
                            const Padding(
                              padding: EdgeInsets.only(top: 19.0),
                              child: Text('INCLINED PUSHUPS x10',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
                            ),
                            const Padding(
                              padding: EdgeInsets.all(8.0),
                  ...
                  const Column(
                    children: [
                      Padding(
                        ...
                        child: Text('INCLINED PUSHUPS',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
                      ),
                      Padding(
                        padding: EdgeInsets.only(left: 45.0, top: 8),
                        child: Text('X10',style: TextStyle(fontWeight: FontWeight.bold),),
                      ),
                    ],
                  )
                ],
              ...
              onTap: () {
                showModalBottomSheet(context: context, builder: ((context){
                  return Scaffold(
                    body: Column(
                      children: [
                        Image.asset('assets/images/knee_diamond.gif'),
                        const Text('KNEE PUSH-UPS x20',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
                        const Padding(
                          padding: EdgeInsets.all(8.0),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      height:100,
                      width: 130,
                      child: Image.asset('assets/images/knee_diamond.gif',fit: BoxFit.cover,),
                    ),
                  ),
                  const Padding(
                    padding: EdgeInsets.only(left: 30.0),
                    child: Column(
                      children: [
                        Text('KNEE PUSH-UPS',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
                        Padding(
                      ...
                      return Scaffold(
                        body: Column(
                          children: [
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Image.asset('assets/images/pushups.gif'),
                            ),
                            const Padding(
                              padding: EdgeInsets.only(top: 19.0),
                              child: Text('PUSH-UPS x10',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
                            ),
                            const Padding(
                              padding: EdgeInsets.all(8.0),
                  ...
                  const Column(
                    children: [
                      Padding(
                        ...
                        child: Text('PUSH-UPS',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
                      ),
                      Padding(
                      ...
                      return Scaffold(
                        body: Column(
                          children: [
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Image.asset('assets/images/wide_pushups.gif'),
                            ),
                            const Padding(
                              padding: EdgeInsets.only(top: 19.0),
                              child: Text('WIDE ARMS PUSH-UPS x10',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
                            ),
                            const Padding(
                              padding: EdgeInsets.all(8.0),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                        height: 100,
                        width: 140,
                        child: Image.asset('assets/images/wide_pushups.gif',fit: BoxFit.cover,)),
                  ),
                  const Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 9.0),
                        child: Text('WIDE ARM PUSHUPS',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
                      ),
                      Padding(
                      ...
                      return Scaffold(
                        body: Column(
                          children: [
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Image.asset('assets/images/cobra_stretch.gif'),
                            ),
                            const Padding(
                              padding: EdgeInsets.only(top: 19.0),
                              child: Text('COBRA STRETCH 20s',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25),),
                            ),
                            const Padding(
                              padding: EdgeInsets.all(8.0),
                              child: Text('Lie down on your back, and put your hands beneath you hips for support.',style: TextStyle(fontSize: 20),),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                        height: 100,
                        width: 140,
                        child: Image.asset('assets/images/cobra_stretch.gif',fit: BoxFit.cover,)),
                  ),
                  const Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.only(left: 29.0),
                        child: Text('COBRA STRETCH',style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
                      ),
                      Padding(
                        padding: EdgeInsets.only(left: 22.0, top: 8),
                        child: Text('20s',style: TextStyle(fontWeight: FontWeight.bold),),
                      ),
                    ],
                  )
                ],
