      ...
      appBar: AppBar(
        ...
        flexibleSpace: Container(
          decoration: const BoxDecoration(
            image: DecorationImage(image: AssetImage('assets/images/absbeginner.jpg'), fit: BoxFit.fill),
          ),
        ),
        title: const Padding(
          padding: EdgeInsets.only(top: 100.0, right: 30.0),
          child: Text('ABS BEGINNER'),
        ),
      ),
            ...
            Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const Fire()));
                  },
